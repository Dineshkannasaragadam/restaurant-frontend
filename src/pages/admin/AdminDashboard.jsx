      ...
      <div className="space-y-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {Array(4).fill(0).map((_, i) => (
            <div key={i} className="h-28 loading-skeleton rounded-2xl" />
          ))}
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {Array(2).fill(0).map((_, i) => (
            <div key={i} className="h-72 loading-skeleton rounded-2xl" />
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-gradient-to-r from-brand-500 to-orange-500 rounded-3xl p-6 text-white overflow-hidden relative"
      >
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-white/90 max-w-xl leading-relaxed">
              ...
              Monitor orders, revenue, customers, and product performance
              all in one place.
            </p>
          ...
          <div className="relative">
            ...
            <div className="w-52 h-52 md:w-64 md:h-64 rounded-3xl overflow-hidden bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl">
              <img
                src={adminpic}
                alt="Admin"
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-3 -left-3 bg-white text-brand-600 px-4 py-2 rounded-2xl shadow-xl">
              <p className="text-xs font-medium">Restaurant Growth</p>
              ...
              <div key={product._id} className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    {product.totalOrders} orders · ₹{product.price}
                  </p>
                </div>
