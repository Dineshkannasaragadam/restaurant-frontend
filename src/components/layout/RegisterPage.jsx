...
// ✅ Field component is OUTSIDE RegisterPage — this fixes the focus bug
function Field({ label, name, type = 'text', icon: Icon, placeholder, value, onChange, error, showPass, onTogglePass }) {
  return (
    <div>
...
export default function RegisterPage() {
  ...
  const validate = () => {
    ...
    if (form.phone && !/^[6-9]\d{9}$/.test(form.phone)) errs.phone = 'Valid Indian phone number required';
  ...
  return (
    <>
      <Helmet><title>Create Account — Athidhi</title></Helmet>
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">Start ordering in minutes</p>
          </div>
